...
@curry
def prepro_fn_copy_bart(tokenizer, max_src_len, max_tgt_len, batch):
...
@curry
def convert_batch_copy_bart(tokenizer, max_src_len, batch):
    stride = 256
...
@curry
def batchify_fn_copy_bart(tokenizer, data, cuda=True):
